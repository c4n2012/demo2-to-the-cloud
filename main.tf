...
helm install --name jenkins --namespace jenkins -f helm/jenkins-chart.yaml stable/jenkins --wait --kubeconfig=${local_file.kubeconfig.filename} --val PROJECT=${var.project_name}
